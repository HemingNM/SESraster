...
After an overview of the [null model algorithms](vignette(%22v1-null-models%22,%20package=%22SESraster%22)) 
summarized in Gotelli ([-@gotelli2000]), let's see how the randomization algorithms
implemented in `SESraster` behave for 
spatial data.
...
#### both, by site and species simultaneously: Equiprobable-Equiprobable {#ee}
...
#### by species: Fixed-Equiprobable {#fe}
...
#### function `bootspat_str()`: Fixed-Proportional {#fp}
...
#### function `bootspat_ff()`: Fixed-Fixed {#ff}
